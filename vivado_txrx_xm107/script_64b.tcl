...
if { [lindex $argv 0] == 0 | $argc != 1 } {
    ...
    add_files $path_src_rx_ip/rx_buffer_wrapper_64b.vhd
    add_files $path_src_tx/
    add_files $path_src_tx_rx/
    add_files $path_src_tx_rx_ip/tx_rx_xcvr_wrapper_64b_ibert.vhd
    add_files $path_src_pkg/esistream6264_pkg_6464.vhd
